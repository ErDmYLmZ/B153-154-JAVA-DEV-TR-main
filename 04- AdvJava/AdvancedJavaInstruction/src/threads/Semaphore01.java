...
class Car extends Thread{
    ...
    public void run() {
        ...
        try {
            semaphore.acquire();//erişim için izin talep edilir, izin verilecek thread sayısı dolmamışsa izin verilir.
            //ortak kaynak
                Thread.sleep(2000);
            ...
            //ortak kaynak
            semaphore.release();//erişim için 1 threadlik alan serbest bırakıldı.

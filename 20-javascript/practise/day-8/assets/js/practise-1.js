document.addEventListener("DOMContentLoaded", () => {
  ...
  const kontrol = () => {
    ...
    if (birinci == ikinci) {
      cards[birinci].setAttribute("src", "assets/images/blank.png");
      cards[ikinci].setAttribute("src", "assets/images/blank.png");
      ...
      cards[birinci].setAttribute("src", "assets/images/white.png");
      cards[ikinci].setAttribute("src", "assets/images/white.png");

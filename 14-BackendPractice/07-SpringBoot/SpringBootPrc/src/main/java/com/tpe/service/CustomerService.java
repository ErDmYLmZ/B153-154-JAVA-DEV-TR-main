...
public class CustomerService {
    ...
    public void deleteCustomerById(Long id) {
        Customer customer = getCustomerById(id); //id yoksa daha önce oluşturulan methoddan dolayı exception fırlatacak
...
//        customerDTO.setPhone(customer.getPhone());
        CustomerDTO customerDTO = new CustomerDTO(customer); //constructorla map leme
        return customerDTO;
    }
